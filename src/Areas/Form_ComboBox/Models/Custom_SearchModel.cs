...
namespace Ext.Net.MVC.Examples.Areas.Form_ComboBox.Custom_Search.Models
{
    public class Plant
    {
        ...
        public static List<Plant> TestData
        {
            get
            {
                ...
                xmlDoc.Load(HttpContext.Current.Server.MapPath("~/Areas/Form_ComboBox/Content/Plants.xml"));
